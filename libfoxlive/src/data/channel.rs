...
impl ChannelLayout {
    ...
    /// Get channel's index based on this layout
    pub fn channel_index(&self, channel: ChannelLayout) -> NChannels {
        (self.bits() & (channel.bits() - 1)).count_ones() as NChannels
    }
    ...
    pub fn n_channels(&self) -> NChannels {
        self.bits().count_ones() as NChannels
    }
}
